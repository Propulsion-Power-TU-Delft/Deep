...
T_r_bounds = [0.9, 1.05]                         # min-max bounds of reduced temperature to compute the saturation curve
s_r_bounds = [1.05, 1.1]                        # min-max bounds of reduced entropy to compute the saturation curve
